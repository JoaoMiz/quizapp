            ...
            <section class="alternativas">
                <form action="">
                    <label for="alternativa_a">
                        <input type="radio" id="alternativa_a" name="alterativa" value="${alterarSinais(quiz.questions[pergunta-1].options[0])}">
                    ...
                    <label for="alternativa_b">
                        <input type="radio" id="alternativa_b" name="alterativa" value="${alterarSinais(quiz.questions[pergunta-1].options[1])}">
                    ...
                    <label for="alternativa_c">
                        <input type="radio" id="alternativa_c" name="alterativa" value="${alterarSinais(quiz.questions[pergunta-1].options[2])}">
                    ...
                    <label for="alternativa_d">
                        <input type="radio" id="alternativa_d" name="alterativa" value="${alterarSinais(quiz.questions[pergunta-1].options[3])}">
